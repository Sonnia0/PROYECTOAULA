...
if (isset($_GET['id'])) {
    ...
    if ($resultado->num_rows == 1) {
        ...
        <body class='bg-gray-900 text-white flex flex-col min-h-screen'>
            ...
            <header class='bg-purple-500 text-gray-900 py-10'>
                <div class='container mx-auto text-center'>
                    <h1 class='text-5xl font-bold'>Editar Producto</h1>
                </div>
            </header>
                ...
                <div class='max-w-lg w-full bg-gray-800 p-6 rounded-lg shadow-lg'>
                    <form action='./actualizar_producto.php' method='POST' enctype='multipart/form-data'>
                        ...
                        <div class='mb-4'>
                            ...
                            <input type='text' id='nombre' name='nombre' value='" . $producto['nombre_producto'] . "' class='bg-gray-700 appearance-none border-2 border-gray-700 rounded w-full py-2 px-4 text-white leading-tight focus:outline-none focus:bg-gray-600 focus:border-indigo-500' required>
                        </div>
                        <div class='mb-4'>
                            <label for='precio' class='block text-white text-sm font-bold mb-2'>Precio:</label>
                            <input type='number' id='precio' name='precio' step='0.01' min='0' value='" . $producto['precio_producto'] . "' class='bg-gray-700 appearance-none border-2 border-gray-700 rounded w-full py-2 px-4 text-white leading-tight focus:outline-none focus:bg-gray-600 focus:border-indigo-500' required>
                        </div>
                        <div class='mb-4'>
                            <label for='descripcion' class='block text-white text-sm font-bold mb-2'>Descripción:</label>
                            <textarea id='descripcion' name='descripcion' rows='4' class='bg-gray-700 appearance-none border-2 border-gray-700 rounded w-full py-2 px-4 text-white leading-tight focus:outline-none focus:bg-gray-600 focus:border-indigo-500' required>" . $producto['descripcion_producto'] . "</textarea>
                        </div>
                        <div class='mb-4'>
                        ...
                        <button type='submit' class='bg-indigo-500 hover:bg-indigo-600 text-white font-bold py-2 px-4 rounded-lg text-xl shadow-lg'>Actualizar Producto</button>
                    </form>
                </div>
            </main>
        ...
        echo "No se encontró el producto solicitado.";
    }
